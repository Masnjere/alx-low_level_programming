 ...
 * @file: name of file buffer is storing chars on behalf of
 *
...
/**
 * main - copy the content of a file to a different file
 ...
 * If file_to can't be created or written on - exit code 99
